...
[Consumer("workflow.target-matched", "workflow.target-matched.handler")]
public class WorkflowTargetMatchedConsumer(
    IOptionsMonitor<RabbitMqOptions> options,
    IRabbitMqService rabbitMqService,
    ILogger<WorkflowTargetMatchedConsumer> logger,
