...
[Consumer("worker.attributes.update", "worker.attributes.update.handler")]
public class WorkerAttributesUpdateConsumer(
    IOptionsMonitor<RabbitMqOptions> options,
    IRabbitMqService rabbitMqService,
    ILogger<WorkerAttributesUpdateConsumer> logger,
