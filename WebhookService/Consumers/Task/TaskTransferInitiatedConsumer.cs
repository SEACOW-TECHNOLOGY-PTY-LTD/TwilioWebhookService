...
[Consumer("task.transfer-initiated", "task.transfer-initiated.handler")]
public class TaskTransferInitiatedConsumer(
    IOptionsMonitor<RabbitMqOptions> options,
    IRabbitMqService rabbitMqService,
    ILogger<TaskTransferInitiatedConsumer> logger,
